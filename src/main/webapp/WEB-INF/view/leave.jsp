  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        function openUserUpdateDialog(){
    		...
    		url="reserveLeave.htm?userId="+row.id;
    	}
...
<div id="dlg" class="easyui-dialog" style="text-align:right;width: 620px;height: 320px;padding: 10px 20px"
 ...
 <form id="fm" method="post">
 	<table cellspacing="5px;">
  		...
  		<tr>
  			<td>开始时间：</td>
  			<td><input class="easyui-datebox"  data-options="formatter:myformatter,parser:myparser" id="bedin" name="begintime"></input></td>
  		</tr>
  		<tr>
  			<td>结束时间：</td>
  			<td><input class="easyui-datebox"  data-options="formatter:myformatter,parser:myparser" id="end" name="endtime"></input></td>
  		</tr>
  	</table>
 </form>
</div>
