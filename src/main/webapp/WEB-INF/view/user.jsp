...
<table  id="dg" class="easyui-datagrid" fitColumns="true"
        ...
        <thead>
            	<tr>
                	...
                	<th field="class_name" width="60" align="center">班级</th>
            	</tr>
        </thead>
</table>
...
<div id="tb" >
	...
	<div>
		...
		<form action="<%=request.getContextPath()%>/user/import.htm" method="post" enctype="multipart/form-data" onsubmit="return check();">
...
<div id="dlg" class="easyui-dialog" style="text-align:right;width: 620px;height: 320px;padding: 10px 20px"
 ...
 <form id="fm" method="post">
 	<table cellspacing="5px;">
  		...
  		<tr>
  			<td>班级：</td>
  			<td><select data-am-selected id="allshi">
				<option value="1" id="classid" name="classid" selected="selected">java一班</option>
				<option value="1" id="classid" name="classid">java二班</option>
				<option value="1" id="classid" name="classid">大数据一班</option>
