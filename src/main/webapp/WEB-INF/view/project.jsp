  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        function reserveUser(){
			...
			var level = opt.val();
    		var score=$("#teacherscore").val();
			url="reserveproject.htm?id="+id+"&teacherscore="+score+"&teacherlevel="+level+"";
        	$("#fm").form("submit",{
    			url:url,
    			onSubmit:function(){
...
<table  id="dg" class="easyui-datagrid" fitColumns="true"
   				 pagination="true" rownumbers="true" url="projectList.htm" fit="true" toolbar="#tb">
        <thead>
            	<tr>
            		<th data-options="field:'ck',checkbox:true"></th>
                	<th data-options="field:'id',width:80" align="center">编号</th>
                	<th field="userName" width="60" align="center">用户名</th>
                	<th field="question" width="60" align="center">项目描述</th>
...
<div id="dlg" class="easyui-dialog" style="text-align:right;width: 620px;height: 320px;padding: 10px 20px"
 ...
 <form id="fm" method="post">
 	<table cellspacing="5px;">
  		...
  		<tr>
  			<td>评分：</td>
  			<td><input type="hidden" id="roleId" name="roleId" /><input type="text" id="teacherscore" name="teacherscore"  class="easyui-validatebox" required="true"/></td>
  		</tr>
  		<tr>
  			<td>评级：</td>
  			<td>
