...
<table  id="dg" class="easyui-datagrid" fitColumns="true"
   				 pagination="true" rownumbers="true" url="studentanswerList.htm" fit="true" toolbar="#tb">
        <thead>
            	<tr>
            		<th data-options="field:'ck',checkbox:true"></th>
                	<th data-options="field:'id',width:80" align="center">用户编号</th>
                	<th field="userName" width="60" align="center">用户名</th>
                	<th field="questionname" width="60" align="center">试卷名</th>
                	<th field="questionanswer" width="60" align="center">回答情况</th>
            	</tr>
        </thead>
</table>
 	...
 	<table cellspacing="5px;">
  		...
  		<tr>
  			...
  			<td><select data-am-selected id="allshi">
				...
				<option value="1" id="classid" name="classid">无</option>
